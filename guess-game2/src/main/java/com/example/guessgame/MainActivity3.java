...
public class MainActivity3 extends MainActivity2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        number = intent.getIntExtra("number",3);
        ...
        button_home.setOnClickListener(view -> {
            Intent main2activityintent = new Intent(MainActivity3.this,MainActivity.class);
            startActivity(main2activityintent);

        });

        button_new.setOnClickListener(view -> {
            game = new Guess_3(number);
            user_input= "";
            count = 0 ;
            time = 0 ;
            display.setText("");
