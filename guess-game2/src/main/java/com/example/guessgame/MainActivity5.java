...
public class MainActivity5 extends MainActivity2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        number = intent.getIntExtra("number",6);
        ...
        button_home.setOnClickListener(view -> {
            Intent main2activityintent = new Intent(MainActivity5.this,MainActivity.class);
